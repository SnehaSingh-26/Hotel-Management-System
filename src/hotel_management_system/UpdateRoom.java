...
PreparedStatement pst = null;
	...
	public UpdateRoom() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Pictures/icons/seventh.jpg"));
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                                ...
                                while(rs1.next()){
                                    txt_Room.setText(rs1.getString("room"));    //room column of customer table
                                }
                            }catch(Exception ee){}
                            try{
                                conn c  = new conn();
                                ...
                                while(rs2.next()){
                                    txt_Ava.setText(rs2.getString("availability")); //availability is column name
