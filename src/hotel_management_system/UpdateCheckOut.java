...
public class UpdateCheckOut extends JFrame {
	 ...
	 * @throws SQLException 
	 */
	public UpdateCheckOut() throws SQLException {
		...
		contentPane.add(lblUpdateCheckStatus);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Pictures/icons/nine.jpg"));
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
				...
				conn c = new conn();
                                ...
                                while(rs1.next())
                                {
                                    txt_ID.setText(rs1.getString("room"));  //write the name of column in db  
